...
def build_parser() -> argparse.ArgumentParser:
    ...
    analyze_topic_lifecycle_cmd = analyze_subparsers.add_parser(
        "topic-lifecycle",
        help=_("cli.analyze.topic_lifecycle.help"),
        description=_("cli.analyze.topic_lifecycle.help"),
    )
    analyze_topic_lifecycle_cmd.add_argument(
        "--input",
        required=False,
        type=Path,
        help=_("cli.analyze.topic_lifecycle.opt.input.help"),
    )
    analyze_topic_lifecycle_cmd.add_argument(
        "--overwrite",
        dest="overwrite",
        action="store_true",
        help=_("cli.analyze.topic_lifecycle.opt.overwrite.help"),
    )
