...
from llm_logparser.cli.handlers import (
    ...
    run_analyze_metrics,
    run_analyze_policy_effectiveness,
    run_analyze_recall,
...
def _dispatch(args, logger) -> None:
    if args.command == "parse":
        ...
        elif args.analyze_command == "token-dictionary":
        ...
        elif args.analyze_command == "cross-thread-memory-recall":
            run_analyze_cross_thread_memory_recall(args, logger)
